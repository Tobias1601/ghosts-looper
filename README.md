...
- **Click-Snap beim Metronom-Recording**: nimmst du Track 1 mit laufendem Metronom auf,
  ist der Loop-Start fest mit Click 1 verknüpft (Frame 0), und das Ende snapt beim
  Ziehen automatisch auf den nächstgelegenen Click
- **Korrekter Sync-Fix**: jede neue Aufnahme auf Track 2-4 wartet jetzt garantiert auf
  den nächsten Nulldurchgang von Track 1 - unabhängig von ½×/1×/2×-Einstellung
