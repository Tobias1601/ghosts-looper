...
private val DE = mapOf(
    "app_title" to "GHOSTS",
    "app_subtitle" to "LOOPER · 04 TRACK",
    "setup" to "SETUP",
    ...
    "latency_test_intro" to "2 LEISE VORZÄHL-KLICKS, DANN 4 KLICKS ZUM MITKLATSCHEN - GENAU AUF JEDEN LAUTEN CLICK.",
    ...
    "latency_legend" to "GESTRICHELT = CLICKS · GRÜN = REFERENZ · ROT = DEIN MARKER"
)
...
private val EN = mapOf(
    ...
    "latency_test_intro" to "2 QUIET LEAD-IN CLICKS, THEN 4 CLICKS TO CLAP ALONG TO - RIGHT ON EACH LOUD CLICK.",
    ...
    "latency_legend" to "DASHED = CLICKS · GREEN = REFERENCE · RED = YOUR MARKER"
)
